...
;
	jmp     L061C
L07E4:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L061C:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
	...
	sec
	sbc     _eject_R
L07E9:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L0646:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L0650
...
;
L0702:	ldy     _coordinates
	lda     _c_map2,y
L07FF:	sta     _collision
;
