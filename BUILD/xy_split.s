...
;
	jmp     L0628
L0842:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L0628:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L0847:	lda     #$00
L083F:	sta     _map_loaded
;
; temp5 = BoxGuy1.x;
;
L06A1:	lda     _BoxGuy1+1
	sta     _temp5+1
	lda     _BoxGuy1
	sta     _temp5
;
...
;
L075F:	ldy     _coordinates
	lda     _c_map2,y
L085A:	sta     _collision
;
