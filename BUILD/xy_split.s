...
;
	jmp     L0613
L07DA:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L0613:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L06FA:	ldy     _coordinates
	lda     _c_map2,y
L07F6:	sta     _collision
;
