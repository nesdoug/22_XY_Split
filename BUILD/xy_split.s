...
;
	jmp     L0618
L07DD:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L0618:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
	...
	sec
	sbc     _eject_R
L07E2:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L0642:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L064C
...
;
L06FE:	ldy     _coordinates
	lda     _c_map2,y
L07F8:	sta     _collision
;
