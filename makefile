...
crt0.o: crt0.s xy_split.chr MUSIC/TestMusic3.s MUSIC/SoundFx.s
	$(CA65) crt0.s

$(NAME).o: $(NAME).s
	$(CA65) $(NAME).s -g

$(NAME).s: $(NAME).c Sprites.h xy_split.h BG/Room1.c BG/Room2.c BG/Room3.c BG/Room4.c BG/Room5.c
